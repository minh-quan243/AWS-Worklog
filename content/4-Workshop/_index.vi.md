...
3. [Giai đoạn 1: Thiết lập nền tảng](4.3-Foundation-Setup/)
4. [Giai đoạn 2: Thiết lập giám sát](4.4-Monitoring-Setup/)
5. [Giai đoạn 3: Thiết lập xử lý](4.5-Processing-Setup/)
6. [Giai đoạn 4: Thiết lập tự động hóa](4.6-Automation-Setup/)
7. [Giai đoạn 5: Thiết lập Dashboard](4.7-Dashboard-Setup/)
8. [Kiểm tra](4.8-Verify-Setup/)
9. [Sử dụng CDK](4.9-Use-CDK/)
10. [Dọn dẹp](4.10-Cleanup/)
11. [Phụ lục](4.11-Appendices/)