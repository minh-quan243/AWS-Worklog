---
title : "Create AWS Glue Database and Tables"
date: "2026-01-11"
weight : 02
chapter : false
pre : " <b> 4.5.2. </b> "
...
1.  **Open Glue Console** → **Databases** → **Add database**

2.  **Database name**: `security_logs`

3.  **Create database**

### Create Tables (Using Athena DDL)

1.  **Open Athena Console**

2.  **Set query result location**: `s3://athena-query-results-ACCOUNT_ID-REGION/`

3.  **Select database**: `security_logs`

#### Create processed\_cloudtrail Table

**Run this DDL in Athena** (replace `ACCOUNT_ID` and `REGION`):
...
#### Create processed\_guardduty Table
