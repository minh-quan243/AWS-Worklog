...
### Create cloudtrail-firehose-stream

1.  **Open Kinesis Console** → **Delivery streams** → **Create delivery stream**
...
### Create vpc-dns-firehose-stream
  ...
  - *(Same buffer/compression settings as above)*

### Create vpc-flow-firehose-stream
